...
from preprocessing import ConfigManager, ROISelector, CannyFeatureEngineer, HoughFeatureEngineer, BEVTransformer
from models import RANSACRegression

class CannyRANSACDetector():
    ...
    def __init__(self, source, roi:NDArray, configs:dict=None, stroke_color:tuple=(0, 0, 255), fill_color:tuple=(0, 255, 0)):
        ...
        self.generator = CannyFeatureEngineer(self.mask.x_mid, pre_configs)
...
if __name__=="__main__":
    ...
    hough = CannyRANSACDetector(src, roi)
